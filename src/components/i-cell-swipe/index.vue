<template>
  <i-cell
    ...
    <div
      slot="right"
      class="i-cell-swipe-buttongroup"
      ref="right">
      <a
        class="i-cell-swipe-button"
        v-for="btn in right"
        :style="btn.style"
...
if (process.env.NODE_ENV === 'component') {
  require('i-ui/packages/cell/style.css');
}
...
export default {
  ...
  mounted() {
    this.wrap = this.$refs.cell.$el.querySelector('.i-cell-wrapper');
    ...
    onDrag(evt) {
      ...
      if (this.direction === 'horizonal') {
        ...
        if ((offsetLeft < 0 && -offsetLeft > this.rightWidth) ||
          ...
          console.log('rightWidth:', this.rightWidth);
...
<style lang="scss">
.i-cell-swipe .i-cell-wrapper, .i-cell-swipe .i-cell-left, .i-cell-swipe .i-cell-right {
