...
.i-swipe-items-wrap > div.is-active {
    display: block;
...
<template>
  <div class="i-swipe">
    <div class="i-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="i-swipe-indicators" v-show="showIndicators">
      <div class="i-swipe-indicator" v-for="(page, $index) in pages" :class="{ 'is-active': $index === index }"></div>
    </div>
  </div>
</template>
